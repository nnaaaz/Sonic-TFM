...
--- Level 1
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-1"].xml, background_color = "#2400b6", duration = 8 * 60}
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"].traps = levels["level-1"].traps
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  ...
  table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"].bonuses, coin)
end
table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"].bonuses, {type = "SonicCheckpoint", x = 292, y = 1076})
table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>"].bonuses, {type = "SonicCheckpoint", x = 6520, y = 995})
table.insert(sonic_maps, "<strike><n>Green Hill Zone</n></strike> <j>Act 1</j>")

--- Level 2
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-2"].xml, background_color = "#2400b6", duration = 8 * 60}
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>"].traps = levels["level-2"].traps
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>"].bonuses, coin)
end
table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>"].bonuses, {type = "SonicCheckpoint", x = 4449, y = 585})
table.insert(sonic_maps, "<strike><n>Green Hill Zone</n></strike> <j>Act 2</j>")

--- Level 3
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 3</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-3"].xml, background_color = "#2400b6", duration = 8 * 60}
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 3</j>"].traps = levels["level-3"].traps
maps["<strike><n>Green Hill Zone</n></strike> <j>Act 3</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Green Hill Zone</n></strike> <j>Act 3</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Green Hill Zone</n></strike> <j>Act 3</j>")

--- special Stage 1
maps["<strike><n>Special Stage</n></strike> <j>1</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["special-stage-1"].xml, background_color = "#00b4b4", duration = 90, autorespawn = false}
maps["<strike><n>Special Stage</n></strike> <j>1</j>"].traps = levels["special-stage-1"].traps
maps["<strike><n>Special Stage</n></strike> <j>1</j>"].bonuses = {}
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Special Stage</n></strike> <j>1</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Special Stage</n></strike> <j>1</j>")
--- Level 4
maps["<strike><n>Marble Zone</n></strike> <j>Act 1</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-4"].xml, background_color = "#0000b6", duration = 8 * 60}
maps["<strike><n>Marble Zone</n></strike> <j>Act 1</j>"].traps = levels["level-4"].traps
maps["<strike><n>Marble Zone</n></strike> <j>Act 1</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Marble Zone</n></strike> <j>Act 1</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Marble Zone</n></strike> <j>Act 1</j>")

--- Level 5
maps["<strike><n>Marble Zone</n></strike> <j>Act 2</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-5"].xml, background_color = "#0000b6", duration = 8 * 60}
maps["<strike><n>Marble Zone</n></strike> <j>Act 2</j>"].traps = levels["level-5"].traps
maps["<strike><n>Marble Zone</n></strike> <j>Act 2</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Marble Zone</n></strike> <j>Act 2</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Marble Zone</n></strike> <j>Act 2</j>")

--- Level 6
maps["<strike><n>Marble Zone</n></strike> <j>Act 3</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-6"].xml, background_color = "#0000b6", duration = 8 * 60}
maps["<strike><n>Marble Zone</n></strike> <j>Act 3</j>"].traps = levels["level-6"].traps
maps["<strike><n>Marble Zone</n></strike> <j>Act 3</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Marble Zone</n></strike> <j>Act 3</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Marble Zone</n></strike> <j>Act 3</j>")

--- special stage 2
maps["<strike><n>Special Stage</n></strike> <j>2</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["special-stage-2"].xml, background_color = "#00b4b4", duration = 90, autorespawn = false}
maps["<strike><n>Special Stage</n></strike> <j>2</j>"].traps = levels["special-stage-2"].traps
maps["<strike><n>Special Stage</n></strike> <j>2</j>"].bonuses = {}
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Special Stage</n></strike> <j>2</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Special Stage</n></strike> <j>2</j>")
--- Level 7
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 1</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-7"].xml, background_color = "#6d246d", duration = 8 * 60}
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 1</j>"].traps = levels["level-7"].traps
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 1</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 1</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Spring Yard Zone</n></strike> <j>Act 1</j>")

--- Level 8
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 2</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-8"].xml, background_color = "#6d246d", duration = 8 * 60}
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 2</j>"].traps = levels["level-8"].traps
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 2</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 2</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Spring Yard Zone</n></strike> <j>Act 2</j>")

--- Level 9
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 3</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["level-9"].xml, background_color = "#6d246d", duration = 8 * 60}
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 3</j>"].traps = levels["level-9"].traps
maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 3</j>"].bonuses = {
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Spring Yard Zone</n></strike> <j>Act 3</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Spring Yard Zone</n></strike> <j>Act 3</j>")

--- special stage 3
maps["<strike><n>Special Stage</n></strike> <j>3</j>"] = {author = "<strike><b><bv>SONIC</bv></b></strike>", xml = levels["special-stage-3"].xml, background_color = "#00b4b4", duration = 90, autorespawn = false}
maps["<strike><n>Special Stage</n></strike> <j>3</j>"].traps = levels["special-stage-3"].traps
maps["<strike><n>Special Stage</n></strike> <j>3</j>"].bonuses = {}
...
for i_coin, coin in ipairs(coins) do
  coin.type = "SonicScore1"
  table.insert(maps["<strike><n>Special Stage</n></strike> <j>3</j>"].bonuses, coin)
end
table.insert(sonic_maps, "<strike><n>Special Stage</n></strike> <j>3</j>")
